...
public class CreateCheaklist:Base{
   ...
   public CreateCheaklist(string GoalType, string GoalName, string GoalDesctription, int PointValue,int Bonus,int NumberTimes,int TimesCompleated ):base(GoalType,GoalName,GoalDesctription,PointValue,Bonus,NumberTimes,TimesCompleated){
